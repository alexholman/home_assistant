$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-label"] = new basedisplay("default-label", "", "default", {'static_icons': [], 'static_css': {'widget_style': 'background-color: #444;', 'unit_style': '', 'state_text_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'value_style': 'color: #fff;', 'title_style': 'color: #fff;'}, 'widget_type': 'basedisplay', 'fields': {'title': '', 'value': 'Hello World', 'title2': '', 'state_text': '', 'unit': ''}, 'icons': [], 'css': {}})
